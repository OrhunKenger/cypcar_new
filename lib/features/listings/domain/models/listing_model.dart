...
class Listing {
  ...
  factory Listing.fromJson(Map<String, dynamic> j) => Listing(
        ...
        category: j['category'] ?? '',
        make: VehicleMakeInfo.fromJson(j['make']),
        series: VehicleSeriesInfo.fromJson(j['series']),
        model: j['model'] != null ? VehicleModelInfo.fromJson(j['model']) : null,
...
class ListingDetail {
  ...
  factory ListingDetail.fromJson(Map<String, dynamic> j) => ListingDetail(
        ...
        isFavorited: j['is_favorited'] ?? false,
        userId: j['user_id'] ?? '',
        userName: j['user_name'] ?? 'Satıcı',
        userPhoto: j['user_photo'],
        userPhone: j['user_phone'],
        userWhatsapp: j['user_whatsapp'],
        createdAt: DateTime.parse(j['created_at']),
        expiresAt: DateTime.parse(j['expires_at']),
      );
